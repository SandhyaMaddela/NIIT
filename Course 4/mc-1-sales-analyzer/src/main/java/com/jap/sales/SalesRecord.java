...
public class SalesRecord {
    ...
    public String toString(){
        return "Date:"+getDate()+"Customer Id"+getCustomer_id()+"Product Category"+product_category+"Payment Method "+payment_method+"Amount "+getAmount()+"time on site "+getTime_on_site()+"Clicks in site "+getClicks_in_site();
    }
}
